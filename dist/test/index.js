...
// console.log(Anytool.removeFromArrayMany(["lol", "aahgaga", "ok"], { elements: ['ok', 2] }));
// console.log(Anytool.removeFromArrayMany(["lol", "aahgaga", "ok"], { indexes: [0, 2] }));
// console.log(Anytool.removeFromArrayMany(["lol", "aahgaga", "ok"], { indexes: [0], elements: ["ok"] }));
